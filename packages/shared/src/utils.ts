...
export const STUDIO37_TENANT_SLUG = 'studio37'
...
export const DEFAULT_WEDDING_SHOT_LIST = [
...
export const DEFAULT_PORTRAIT_SHOT_LIST = [
...
export const DEFAULT_EQUIPMENT_CHECKLIST = [
...
// Date formatting
export function formatShootDate(date: string | Date): string {
...
// Shot list progress
export function calculateShootProgress(shotList: Array<{ completed: boolean }>): number {
  if (!shotList || shotList.length === 0) return 0
